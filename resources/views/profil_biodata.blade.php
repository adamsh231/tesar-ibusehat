                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->biodata_id }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">Keluhan</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->keluhan }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">riwayat penyakit</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->riwayat_penyakit }}</label>
                                        </div>
                                        ...
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->menikah_ke }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">usia menikah</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->usia_menikah }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">lama menikah</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->lama_menikah }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">HPHT</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->HPHT }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">menarche</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->menarche }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">lama haid</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->lama_haid }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">siklus haid</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->siklus_haid }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">warna</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->warna }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">flour albus</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->flour_albus }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">riwayat kehamilan</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->riwayat_kehamilan }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">riwayat kb</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->subjektif->riwayat_kb }}</label>
                                        </div>
                                        < </div>
                                            <div>
                                                <a scope="col" href="{{ route('subjektif.edit', $biodata->subjektif->id) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->kesadaran }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">tekanan_darah</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->tekanan_darah }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">suhu</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->suhu }}/C</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">nadi</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->nadi }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">respirasi</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->respirasi }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">bb</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->bb }} Kg</label>
                                        </div>
                                        ...
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->kepala }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">rambut</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->rambut }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">muka</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->muka }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">mata</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->mata }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">hidung</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->hidung }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">telinga</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->telinga }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">mulut</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->mulut }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">leher</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->leher }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">dada</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->dada }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">abdomen</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->abdomen }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">leopold 1</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->leopold1 }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">leopold 2</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->leopold2 }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">leopold 3</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->leopold3 }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">leopold 4</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->leopold4 }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">genetalia</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->genetalia }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">eks_atas</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->eks_atas }}</label>
                                        </div>

                                        <label for="staticEmail" class="col-sm-2 col-form-label">eks_bawah</label>
                                        <div class="col-sm-10">
                                            <label class="col-sm-2 col-form-label">{{ $biodata->objektif->eks_bawah }}</label>
                                        </div>
                                <a scope="col" href="{{ route('subjektif.create') }}"
                                    class="btn btn-primary mr-2">Tambah Data Baru</a>
                            </div>
