            ...
            <div class="card-body">
                ...
                <form action="{{ route('subjektif.update', $subjektif->id) }}" method="POST">
                    ...
                    <ul class="list-group">
                        ...
                        Riwayat Penyakit <input type="text" name="inputriwayat" required value="{{ $subjektif->riwayat_penyakit }}">
                        Riwayat Penyakit Keluarga <input type="text" name="inputkeluarga" required value="{{ $subjektif->riwayat_penyakit_keluarga }}">
                        Menikah Ke <input type="number" name="inputmenikah_ke" required value="{{ $subjektif->menikah_ke }}">
                        Usia Menikah <input type="number" name="inputusia_menikah" required value="{{ $subjektif->usia_menikah }}">
